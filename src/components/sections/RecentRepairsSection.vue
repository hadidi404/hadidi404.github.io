<template>
  <section>
    <div class="max-w-7xl mx-auto space-y-4 px-8 py-20">
      <div class="flex flex-col items-center justify-center space-y-4 mb-16">
        <p
          class="w-fit flex justify-center text-xl text-blue-700 font-semibold  bg-blue-100 rounded-full items-center px-4 py-2"
        >
          OUR WORK
        </p>
        <h1 class="text-6xl font-bold">Recent Repairs</h1>
