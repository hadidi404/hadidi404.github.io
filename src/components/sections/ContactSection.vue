<template>
  <section id="contact" class="flex flex-col items-center justify-center">
    <div class="mx-auto w-full max-w-5xl px-8 space-y-6 py-12 sm:py-20">
      ...
      <div v-animate="150"
        class="flex flex-col items-center justify-center w-full shadow-2xl rounded-3xl p-6 sm:p-12 border border-gray-200 bg-white/8 space-y-4 bg-linear-to-br from-white to-[#F9FAFB]">
